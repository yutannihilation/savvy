...
[![](https://img.shields.io/crates/v/savvy?style=flat-square&logo=rust)](https://crates.io/crates/savvy)
[![](https://img.shields.io/docsrs/savvy?style=flat-square&logo=docsdotrs)](https://docs.rs/savvy/latest/)
...
With savvy, you can implement Rust function like below to create the corresponding R function `to_upper()`. As you can see, this framework is unfriendly in that this requires more explicit operations than extendr. For the full details, please read [the crate documentation](https://yutannihilation.github.io/savvy/savvy/index.html).
