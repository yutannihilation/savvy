---
title: "Savvy - A simple R extension interface using Rust"
format: gfm
...
A toy example R package can be found in [`R-package/` directory](https://github.com/yutannihilation/savvy/tree/main/R-package).
