...
SEXP savvy_get_var_in_env__ffi(SEXP env, SEXP name);
SEXP savvy_var_exists_in_env__ffi(SEXP env, SEXP name);
SEXP savvy_set_var_in_env__ffi(SEXP env, SEXP name, SEXP value);
