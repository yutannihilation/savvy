...
SEXP savvy_times_two_real__ffi(SEXP x);
SEXP savvy_times_any_real__ffi(SEXP x, SEXP y);
...
SEXP savvy_tweak_altint__ffi(SEXP x);
SEXP savvy_altreal__ffi(void);
SEXP savvy_print_altreal__ffi(SEXP x);
SEXP savvy_tweak_altreal__ffi(SEXP x);
...
SEXP savvy_default_value_enum__ffi(SEXP x);
...
SEXP savvy_struct_fn__ffi(SEXP r#fn);