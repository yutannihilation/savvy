...
pub use codegen::c::{generate_c_header_file, generate_c_impl_file};
pub use codegen::r::generate_r_impl_file;
pub use codegen::static_files::{
    ...
    generate_makevars_in, generate_makevars_win_in, generate_rustarch_r, generate_win_def,
};
